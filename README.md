...
- **Decide** — Make architectural decisions and write refutable behavior scenarios. Each decision traces to research.
...
This plugin was built using RDD. The full artifact trail — seven research essays, 36 architectural decisions, 192 behavior scenarios, a domain model, system design, and product discovery document — lives in the `docs/` directory.
