...
The recommended TS-1-first sequencing has shipped A + B. TS-2 (skill-side) has shipped C + D. WP-E is now fully unblocked on its implied deps. WP-F is the remaining independent start in TS-2. WP-G sits at TS-1 completion — small utility, hard-dep satisfied.
