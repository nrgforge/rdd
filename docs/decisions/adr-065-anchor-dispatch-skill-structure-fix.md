...
Output path: .rdd/audits/susceptibility-snapshot-{cycle}-{phase}.md
```
...
- `skills/research/SKILL.md` — citation-auditor dispatch at the "after the essay is written" step, with canonical path `.rdd/audits/citation-audit-{cycle}.md`.
- `skills/research/SKILL.md` — argument-auditor dispatch at the "after the essay is written" step, with canonical path `.rdd/audits/argument-audit-{cycle}.md`.
- `skills/research/SKILL.md` — research-methods-reviewer dispatch at the "before the first research loop" step, with canonical path `.rdd/audits/research-design-review-{cycle}.md`.
- `skills/decide/SKILL.md` — argument-auditor dispatch at "after ADRs are written," with canonical path `.rdd/audits/argument-audit-decide-{cycle}.md`.
