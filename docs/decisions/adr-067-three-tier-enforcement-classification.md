...
- **"Not a priority hierarchy" framing:** MODEL-phase settled premise 4 as recorded in `docs/housekeeping/cycle-status.md` feed-forward signals: *"The three-tier classification is not a priority hierarchy. Each layer is primary in its domain."* User-surfaced at MODEL gate 2026-04-08.
