...
- **The infrastructure-vs-audience axis distinction:** user-surfaced at the DISCOVER gate (recorded in `docs/housekeeping/audits/susceptibility-snapshot-017-discover.md` Moment 3 — the agent's §4.1 conflation correction). User-surfaced; audit-recorded.
